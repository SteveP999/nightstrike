@echo off
:: ============================================================
:: Hello Texas Records — Artist Update Script
:: Drop this in any artist folder on D:\
:: Run after editing songs.json to add a new song
:: ============================================================
...
where node >nul 2>&1
if %errorlevel% neq 0 (
  echo WARNING: Node.js not found. Skipping auto-generation.
  goto :PUSH
)
